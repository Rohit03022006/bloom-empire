            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4 z-10">
                  <div
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex-shrink-0 flex items-center justify-center text-xl sm:text-2xl transition-all duration-500 icon-glassmorphism group-hover:scale-110"
                    style={{
